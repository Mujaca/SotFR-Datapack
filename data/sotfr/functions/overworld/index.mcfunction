...
execute at @e[type=armor_stand,limit=1,tag=spawn] as @s[distance=..300,gamemode=survival] unless score @s shadow_ticks matches 0 run scoreboard players set @s shadow_ticks 0
