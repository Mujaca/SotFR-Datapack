...
execute if score players bossfight1 matches ..2 run scoreboard players set countdown bossfight1 1200
...
execute if score players bossfight1 matches ..2 run title @a[tag=waitingF1] actionbar ["",{"score":{"name":"players","objective":"bossfight1"}},{"text":"/2 to start Bossfight"}]
