...
execute in sotfr:void positioned 288 12 -225 if score @e[name=random,tag=random,limit=1] random matches 0..2 as @a[tag=bossfight] run function sotfr:bossfights/ads/brute
execute in sotfr:void positioned 288 12 -225 if score @e[name=random,tag=random,limit=1] random matches 2..4 as @a[tag=bossfight] run function sotfr:bossfights/ads/skeleton
